...
class Deal(BaseModel):
    ...
    comment: str = Field(
        title="Комментарий к сделке", description="Комментарий к сделке"
    )
    ...
    persons_in_charge: list[str] = Field(
        title="Список ответственных лиц", description="Список ответственных лиц"
    )
